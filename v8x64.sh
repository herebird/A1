...
clear
    ...
    =============== OS-32 & 64-bit ================
            ...
            AUTOSCRIPT CREATED BY HERE BIRD LNWSHOP
         
               SCRIPT VIP : 097-026-7262                					         	       
    =============== OS-32 & 64-bit ================
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	clear
	echo 'ติดตั้ง OpenVPN Script "โดย เฮียเบิร์ด" '
	echo ""
...
rcvbuf 0
<connection>
remote HERE-BIRD-LNWSHOP 9999 udp
</connection>
http-proxy-retry
http-proxy $IP 8080
...
echo "  Copyright By_ HERE BIRD LNWSHOP   "
echo "VPN Config"
